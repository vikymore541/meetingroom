...
@section('content')
    <div>
        <section class="page-header min-vh-80"
            style="background-image: url(&#39https://images.unsplash.com/photo-1573166675921-076ea6b621ce?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D;);"
            loading="lazy">
            <span class="mask bg-gradient-dark opacity-5"></span>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-7 d-flex justify-content-center flex-column">
                        <h1 class="text-white mb-4">Welcome to Meeting Room</h1>
                        <p class="text-white opacity-8 lead pe-5 me-5">"Seamless Meeting Room Booking Made Easy. Experience Convenience, Efficiency, and Professional Spaces with  BookMeeting App </p>
                        <div class="buttons">
            ...
            <section class="py-4">
                <div class="container">
                    <div class="row  align-items-center">
                        <div class="col-lg-3">
                        <h1>Find Your <br> Ideal Meeting Space</h1>
                        </div>
                        <div class="col-lg-3">
